"""Regression checks for the packet-model-metric-grid casebook."""
...
from casebook.harness import assert_expected, packet_model_metric_grid_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(packet_model_metric_grid_summary(), assert_expected())
